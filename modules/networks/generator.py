...
from modules.networks.architecture import ResnetBlock as ResnetBlock
from modules.networks.architecture import SPADEResnetBlock as SPADEResnetBlock

class OLIEGenerator(BaseNetwork):
    @staticmethod
